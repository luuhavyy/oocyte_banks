...
const menuItems = [
  ...
  { label: "Medical History", link: "/medical-history", icon: MedicalServicesIcon },
  { label: "Appointments", link: "/appointments", icon: EventIcon },
  { label: "Evaluation History", link: "/history", icon: HistoryIcon },
  { label: "Help", link: "/help", icon: HelpIcon },
];

export default function DrawerClient({ open, collapsed, onClose, onToggle }) {
