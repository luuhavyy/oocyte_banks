...
export default function TopBarClient({ pageTitle = "", sidebarOpen = true, sidebarWidth = 220 }) {
  ...
  const roleDisplay = user?.subrole === "donor" ? "DONOR" : user?.subrole === "recipient" ? "RECIPIENT" : "PATIENT";
